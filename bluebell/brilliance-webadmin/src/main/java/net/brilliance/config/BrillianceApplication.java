...
@EnableAsync
public class BrillianceApplication extends WebMvcConfigurerAdapter {
	...
	public static void main(String[] args) {
		SpringApplication app = new SpringApplication(BrillianceApplication.class);
		app.run(args);
	 ...
	 * {@link BrillianceApplication#localeChangeInterceptor localeChangeInterceptor}.
	 * <br />
	 ...
	 * @see BrillianceApplication#localeChangeInterceptor
	 */
	@Bean
